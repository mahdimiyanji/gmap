...
export default tseslint.config({
  ...
  rules: {
    ...
    "@stylistic/padding-line-between-statements": [
      ...
      { blankLine: "always", prev: ["multiline-expression", "multiline-const"], next: ["multiline-const", "const", "return"] },
      { blankLine: "always", prev: "singleline-const", next: ["multiline-const"] },
      { blankLine: "always", prev: ["case", "default"], next: "*" },
      { blankLine: "always", prev: ["singleline-const", "multiline-const", "multiline-expression"], next: "multiline-expression" },
    ],
